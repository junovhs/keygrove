...
const SPECS: Omit<Trail, 'n'>[] = [
  ...
  ...grove('canopy', [
    { name: 'Middle Up', newKeys: 'ei', kind: 'words', length: 44 },
    { name: 'Index Up', newKeys: 'ru', kind: 'words', length: 44 },
    { name: 'Index Stretch Up', newKeys: 'ty', kind: 'words', length: 44 },
  ...
  ...grove('undergrowth', [
    { name: 'Index Down', newKeys: 'vm', kind: 'words', length: 46 },
    { name: 'Index Stretch Down', newKeys: 'bn', kind: 'words', length: 46 },
    { name: 'Middle Down', newKeys: 'c,', kind: 'words', length: 46 },
    { name: 'Ring Down', newKeys: 'x.', kind: 'words', length: 46 },
    { name: 'Pinky Down', newKeys: 'z/', kind: 'words', length: 46 },
