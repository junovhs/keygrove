...
const SPECS: Omit<Trail, 'n'>[] = [
  ...
  ...grove('canopy', [
    { id: 'index-stretch-up', name: 'Across the Stagger', newKeys: 'cy', kind: 'words', length: 44, blurb: 'C is your {c}; Y your {y}. A small hand adjustment is welcome.' },
  ...
  ...grove('undergrowth', [
    ...
    { id: 'index-stretch-down', name: 'Connected Index Movements', newKeys: '', kind: 'words', length: 46, blurb: 'Connect C, V, B, N and M with the rest of a word. Prepare instead of resetting.' },
