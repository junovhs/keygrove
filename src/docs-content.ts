...
export const docs = defineDocs({
  ...
  sections: [
    ...
    { id: 'progress', title: 'How you advance', question: 'How do I finish a lesson?', answer: 'Repeated accurate practice, enough experience with its keys, and a fresh passage complete a lesson. Chapter passages require 97% accuracy. Speed never unlocks or blocks a lesson.', blocks: [
      { kind: 'p', text: 'Early lessons aim for 90% accuracy. The target rises gradually to 96% in Flow. Finish one passage at the shown target and you move straight to the next lesson. Chapter passages need 97% accuracy. There are no hidden repeat requirements; earlier keys keep appearing as you progress.' },
