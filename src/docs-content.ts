...
export const docs = defineDocs({
  ...
  sections: [
    ...
    { id: 'progress', title: 'How you advance', question: 'How do I finish a lesson?', answer: 'Each lesson has a short, visible sequence of exercises. Every accuracy pass moves you forward; the last exercise completes the lesson. Chapter passages require 97% accuracy. Speed is never a gate.', blocks: [
      { kind: 'p', text: 'Early lessons aim for 90% accuracy. The target rises gradually to 96% in Flow. Each lesson shows its exercise count and purpose: meet the movements, connect them, then use words and passages. Every pass at the shown accuracy target advances one exercise. The last exercise opens the next lesson. Chapter passages need 97% accuracy. There are no hidden repeat requirements; completed exercises and lessons stay saved.' },
