...
export type CharmMotion = 'shower' | 'cat' | 'grow' | 'rise' | 'kite' | 'crawl' | 'run' | 'hop' | 'flutter' | 'swing' | 'music' | 'fly' | 'flock' | 'loop' | 'streak' | 'slither' | 'swim' | 'spin';
...
export const KEEPSAKES: readonly Keepsake[] = [
  ...
  chapter('cat', 'home', 'home-checkpoint', 'The house cat', 'The home row feels like home now.', 'Someone is waiting at Home.', 'cat'),
